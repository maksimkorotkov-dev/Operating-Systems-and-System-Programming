...
```Child (PID: 6022) sleeping 20 seconds. Check with ps...   ```
...
**CMD** – command name
This demonstrates that all threads belong to the same process but have unique IDs.
